...
| File | Skill | Purpose |
|-----------|-------|---------|
| `plan/SKILL.md` | omk-plan | Strategic planning with interview workflow |
...
| `sciomk/SKILL.md` | sciomk | Parallel scientist orchestration |
...
| `ask/SKILL.md` | ask | Ask Claude, Codex, or Gemini via `omk ask` and capture an artifact |
...
| `omk-doctor/SKILL.md` | omk-doctor | Diagnose installation issues |
| `setup/SKILL.md` | setup | Unified setup entrypoint for install, diagnostics, and MCP configuration |
| `omk-setup/SKILL.md` | omk-setup | One-time setup wizard |
| `omk-help/SKILL.md` | omk-help | Usage guide |
...
| `release/SKILL.md` | release | Generic release assistant — analyzes repo CI/rules, caches in `.omk/RELEASE_RULE.md`, guides the release |
...
handoff: .omk/plans/example.md           # Optional: artifact/context handed to next skill
---
...
| Planning | omk-plan, ralplan, deep-interview, ralph-init | "plan this", "interview me", "ouroboros" |
| Exploration | deepinit, sciomk, external-context | "deepinit", "research" |
| Utility | skillify, learner (deprecated alias), note, cancel, hud, setup, omk-doctor, omk-setup, omk-help, mcp-setup | "stop", "cancel" |
