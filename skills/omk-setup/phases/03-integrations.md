...
#### 3.3.3: Configure Team Defaults in omk-config
...
Store the team configuration in the active Claude config directory's `.omk-config.json`:
...
Or by running `/oh-my-kimi:omk-setup --force` and choosing to enable teams.
